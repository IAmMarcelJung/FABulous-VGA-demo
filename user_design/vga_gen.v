module vga_gen #(
    ...
    output wire [11:0] x,     // Display position X (adjusted for offset)
    output wire [11:0] y      // Display position Y (adjusted for offset)
);
    ...
    // Counter organization: Visible -> Front Porch -> Sync -> Back Porch
    // Display position outputs (adjusted for offsets)
    assign x = hcnt - H_OFFSET;
    assign y = vcnt - V_OFFSET;
